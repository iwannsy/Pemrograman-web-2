      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
          <div class="jumbotron" style="margin: 20px 20px 20px 20px; padding: 20px 20px 20px 20px">
              ...
              Ini Adalah Tugas Pemrograman Web 2 
              </h2>
              ...
              <br>
              <p>
                Kelompok 4 Kelas 06TPLM010 <br>
                  <ul>
                    <li>Fikri Mutaqin</li>
                    <li>Guntur Leon Saputra</li>
                    <li>Hesti Rahmawati</li>
                    <li>Ichwanul Syarif H.</li>
                    <li>Ilham Dwi Nugraha</li>
                  </ul>
              </p>
          </div>
        </div>
